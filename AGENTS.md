...
This project is indexed by GitNexus as **local-repo-mcp** (313 symbols, 767 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
