...
This project is indexed by GitNexus as **local-repo-mcp** (336 symbols, 795 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
